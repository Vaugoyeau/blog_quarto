...
- [Initiation à Shiny](https://marievaugoyeau.fr/posts/shiny/)\
- [Réaliser une appli avec `{shiny}` & `{bslib}`](https://marievaugoyeau.fr/posts/shiny_bslib/)

Ainsi que les articles sur `Quarto` si tu n'es pas à l'aise avec la syntaxe associée :

- [Initiation à Quarto](https://marievaugoyeau.fr/posts/quarto_initiation/)\
- [Intégrer {shiny} dans un document quarto](https://marievaugoyeau.fr/posts/shiny_quarto/)
...
Dans le live, j'ai décidé de repartir de l'[appli développée en décembre](https://marievaugoyeau.fr/posts/shiny_bslib/).\
